...
fun navigateToFragment(
    activity: Activity,
    navHostFragmentContainer: Int,
    fragmentToNavigate: Int
) {
    val navController: NavController =
        Navigation.findNavController(activity, navHostFragmentContainer)
...
/*
   public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        htmlContent.append(String.format("<!DOCTYPE html>\n" +
                ...
                "                        <img src=\"https://superdevresources.com/wp-content/uploads/2016/05/html-resume-template.jpg\" alt=\"Smiley face\" width=\"42\" height=\"42\" style=\"border:5px solid black\">\n" +
                "                    </td>\n" +
